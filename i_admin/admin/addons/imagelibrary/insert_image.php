...
<span style="font-family: arial, verdana, helvetica; font-size: 11px; font-weight: bold;">Inserez une Image:</span>
<table width="380" border="0" cellpadding="0" cellspacing="0" style="background-color: #F7F7F7; border: 2px solid #FFFFFF; padding: 5px;">
	...
	?>
		<tr>
			<td style="padding-top: 0px;padding-bottom: 0px; font-family: arial, verdana, helvetica; font-size: 11px;width:80px;">Telechragement:</td>
		...
		<tr>
			...
			<td style="padding-top: 0px;padding-bottom: 2px;font-family: tahoma; font-size: 9px;">(Taille max: <?php echo $phpmaxsize; ?>Ko)</td>
		</tr>
	<?php
		}
		else {
	?>
		<tr>
			<td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;" colspan="2">
				Le telechargement des fichier est desactive dans php.ini, veuillez le reactiver svp:
	...
	<tr>
		<td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;">Texte alternatif:</td>
...
<span style="font-family: arial, verdana, helvetica; font-size: 11px; font-weight: bold;">Presentation:</span>
<table width="180" border="0" cellpadding="0" cellspacing="0" style="background-color: #F7F7F7; border: 2px solid #FFFFFF; padding: 5px;">
<tr>
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;">Largeur:</td>
 ...
 <tr>
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;">Hauteur:</td>
 ...
 <tr>
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;">Bordure:</td>
...
<tr>
  <td style="width: 115px;padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;" width="100">Alignement:</td>
	...
	<select name="align" id="align" style="font-family: arial, verdana, helvetica; font-size: 11px; width: 100%;">
	 ...
	 <option value="texttop">Texte au dessus</option>
	 <option value="absmiddle">pres du centre</option>
	 <option value="baseline">Ligne de fond</option>
	 <option value="absbottom">Trop bas</option>
 ...
 <tr>
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;">Espace Horizontal:</td>
 ...
 <tr>
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;">Espace Vertical :</td>
...
<td style="vertical-align: top;width: 150px; padding-left: 5px;">
	<span style="font-family: arial, verdana, helvetica; font-size: 11px; font-weight: bold;">Selectionner une Image:</span>
...
<tr>
	<td colspan="2" align="right" style="padding-top: 5px;">
		...
		<?php if ( $allowuploads ) { ?> 
			<input type="submit" value="  Telecharger  " style="font-size: 12px;">
		<?php } ?> 		
		<input type="button" value="  Annuler  " onclick="window.close();" style="font-size: 12px;">	
	</td>
</tr>
</form>
</table>
