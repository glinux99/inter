<nav class="navbar navbar-expand-lg navbar-dark bg px-3">
    <div class="nav-brand">
        <img src="<?php echo $dir;?>i_menu/logo.png" alt="logo" class="d-block" height="40" width="60">
    </div>
    ...
    <div class="collapse navbar-collapse coll justify-content-center">
        <ul class="nav nav-pills bi--lg" role="tablist" style="display: ;">
            ...
            <li class="navbar-item">
                <a href="<?php echo $dir;?>apropos" class="nav-link" role="tab" aria-selected="true">
                    <span class="bi-info-circle"></span><?php echo _("A propos");?>
                </a>
            </li>
            <li class="navbar-item">
                <a href="<?php echo $dir;?>i_services/services" class="nav-link" role="tab" aria-selected="true">
            ...
            <li class="navbar-item">
                <a href="<?php echo $dir;?>i_login/login" class="nav-link" role="tab" aria-selected="true">
